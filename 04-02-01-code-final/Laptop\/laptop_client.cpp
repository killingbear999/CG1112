...
#define SERVER_NAME_ON_HOST	"alex.epp.com"

/* END TODO */
void connectToServer(const char *serverName, int portNum)
{
    /* TODO: Create a new client */
	createClient(serverName, portNum, 1, CA_CERT_FNAME, SERVER_NAME_ON_HOST, 1, CLIENT_CERT_FNAME, CLIENT_KEY_FNAME, readerThread, writerThread);
    /* END TODO */
}
